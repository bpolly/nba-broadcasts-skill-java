 ...
 * <p>
 */
public class SportsBroadcastsSpeechlet_Reference implements Speechlet {
    private static final Logger log = LoggerFactory.getLogger(SportsBroadcastsSpeechlet_Reference.class);
